...
public class ViatraTransformation implements TestInterface {
    ...
    /**
     * Reads the java program located at the given path and creates the according program graph. This method will be
     * only called on the extended case. On the basic case setProgramLocation(String).
     *
    ...
    /**
     * Gives the location of the java program on which refactorings will be applied to a solution. This method will
     * only be called in the basic case. In the extended case createProgramGraph(String) will be called instead.
     *
     * @param path Absolute path to a java programs main folder
    ...
    /**
     * Returns weather the solution is realizing the basic case or the extended case. In the extended case the given
     * type graph has to be used as intermediate representation on which the refactorings will be applied.
     *
     * @return true iff the solution the solution uses the given Type graph as intermediate representation, otherwise
     * false.
     */
    @Override
    ...
    /**
     * Synchronizes the java code with the program graph and propagates all changes made in the program graph to the
     * java source code. Synchronizing the program graph with the source code is only allowed when this method s
     * called. This method will be only called in the extended case. In the basic case there is no equivalent method.
     *
    ...
    /**
     * Hands a File representation of a folder to the solution where data can be stored temporal. The folder is
     * automatically cleaned up when the test toll is closed.
     *
     * @param path a File representation of the path
     */
    @Override
