...
public class TClassImpl extends MinimalEObjectImpl.Container implements TClass {
		...
		if (parentClass != null && parentClass.eIsProxy()) {
			...
			if (parentClass != oldParentClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypeGraphBasicPackage.TCLASS__PARENT_CLASS, oldParentClass, parentClass));
			}
		}
		return parentClass;
	}
	...
	public NotificationChain basicSetParentClass(TClass newParentClass, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypeGraphBasicPackage.TCLASS__PARENT_CLASS, oldParentClass, newParentClass);
	...
	public void setParentClass(TClass newParentClass) {
		if (newParentClass != parentClass) {
			...
			if (parentClass != null)
				msgs = ((InternalEObject)parentClass).eInverseRemove(this, TypeGraphBasicPackage.TCLASS__CHILD_CLASSES, TClass.class, msgs);
			if (newParentClass != null)
				msgs = ((InternalEObject)newParentClass).eInverseAdd(this, TypeGraphBasicPackage.TCLASS__CHILD_CLASSES, TClass.class, msgs);
			msgs = basicSetParentClass(newParentClass, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypeGraphBasicPackage.TCLASS__PARENT_CLASS, newParentClass, newParentClass));
	}
	...
	public EList<TClass> getChildClasses() {
		if (childClasses == null) {
			childClasses = new EObjectWithInverseResolvingEList<TClass>(TClass.class, this, TypeGraphBasicPackage.TCLASS__CHILD_CLASSES, TypeGraphBasicPackage.TCLASS__PARENT_CLASS);
		}
		return childClasses;
	}
	...
	public NotificationChain basicSetPackage(TPackage newPackage, NotificationChain msgs) {
		...
		package_ = newPackage;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypeGraphBasicPackage.TCLASS__PACKAGE, oldPackage, newPackage);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setPackage(TPackage newPackage) {
		if (newPackage != package_) {
			NotificationChain msgs = null;
			if (package_ != null)
				msgs = ((InternalEObject)package_).eInverseRemove(this, TypeGraphBasicPackage.TPACKAGE__CONTAINED_CLASSES, TPackage.class, msgs);
			if (newPackage != null)
				msgs = ((InternalEObject)newPackage).eInverseAdd(this, TypeGraphBasicPackage.TPACKAGE__CONTAINED_CLASSES, TPackage.class, msgs);
