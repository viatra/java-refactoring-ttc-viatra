...
public class TPackageImpl extends MinimalEObjectImpl.Container implements TPackage {
	...
	public EList<TClass> getContainedClasses() {
		if (containedClasses == null) {
			containedClasses = new EObjectWithInverseResolvingEList<TClass>(TClass.class, this, TypeGraphBasicPackage.TPACKAGE__CONTAINED_CLASSES, TypeGraphBasicPackage.TCLASS__PACKAGE);
		}
	...
	public EList<TPackage> getSubpackage() {
		if (subpackage == null) {
			subpackage = new EObjectContainmentWithInverseEList<TPackage>(TPackage.class, this, TypeGraphBasicPackage.TPACKAGE__SUBPACKAGE, TypeGraphBasicPackage.TPACKAGE__PARENT);
		}
		return subpackage;
	}
	...
	public TPackage getParent() {
		if (eContainerFeatureID() != TypeGraphBasicPackage.TPACKAGE__PARENT) return null;
