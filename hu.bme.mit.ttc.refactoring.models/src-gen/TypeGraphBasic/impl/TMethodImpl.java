...
public class TMethodImpl extends MinimalEObjectImpl.Container implements TMethod {
	...
	public EList<TMethodSignature> getSignatures() {
		if (signatures == null) {
			signatures = new EObjectContainmentWithInverseEList<TMethodSignature>(TMethodSignature.class, this, TypeGraphBasicPackage.TMETHOD__SIGNATURES, TypeGraphBasicPackage.TMETHOD_SIGNATURE__METHOD);
		}
		return signatures;
	}
	...
	public void setTName(String newTName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypeGraphBasicPackage.TMETHOD__TNAME, oldTName, tName));
	}
