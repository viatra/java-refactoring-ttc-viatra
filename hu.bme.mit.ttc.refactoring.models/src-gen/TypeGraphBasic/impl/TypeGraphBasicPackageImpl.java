...
import TypeGraphTrace.impl.TypeGraphTracePackageImpl;
...
public class TypeGraphBasicPackageImpl extends EPackageImpl implements TypeGraphBasicPackage {
	...
	public static TypeGraphBasicPackage init() {
		if (isInited) return (TypeGraphBasicPackage)EPackage.Registry.INSTANCE.getEPackage(TypeGraphBasicPackage.eNS_URI);

		// Obtain or create and register package
		TypeGraphBasicPackageImpl theTypeGraphBasicPackage = (TypeGraphBasicPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TypeGraphBasicPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TypeGraphBasicPackageImpl());

		isInited = true;

		// Obtain or create and register interdependencies
		TypeGraphTracePackageImpl theTypeGraphTracePackage = (TypeGraphTracePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(TypeGraphTracePackage.eNS_URI) instanceof TypeGraphTracePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(TypeGraphTracePackage.eNS_URI) : TypeGraphTracePackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getTClass_Signature(), this.getTSignature(), null, "signature", null, 0, -1, TClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTClass_Package(), this.getTPackage(), this.getTPackage_ContainedClasses(), "package", null, 1, 1, TClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTClass_Defines(), this.getTMember(), null, "defines", null, 0, -1, TClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTClass_TName(), ecorePackage.getEString(), "tName", null, 1, 1, TClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getTField_TName(), ecorePackage.getEString(), "tName", null, 1, 1, TField.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getTFieldSignature_Type(), this.getTClass(), null, "type", null, 1, 1, TFieldSignature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tMemberEClass, TMember.class, "TMember", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTMember_Access(), this.getTMember(), null, "access", null, 0, -1, TMember.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTMethod_TName(), ecorePackage.getEString(), "tName", null, 1, 1, TMethod.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEReference(getTMethodDefinition_ReturnType(), this.getTClass(), null, "returnType", null, 0, 1, TMethodDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTMethodSignature_ParamList(), this.getTClass(), null, "paramList", null, 0, -1, TMethodSignature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tPackageEClass, TPackage.class, "TPackage", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTPackage_ContainedClasses(), this.getTClass(), this.getTClass_Package(), "containedClasses", null, 0, -1, TPackage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTypeGraph_Methods(), this.getTMethod(), null, "methods", null, 0, -1, TypeGraph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTypeGraph_Fields(), this.getTField(), null, "fields", null, 0, -1, TypeGraph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
