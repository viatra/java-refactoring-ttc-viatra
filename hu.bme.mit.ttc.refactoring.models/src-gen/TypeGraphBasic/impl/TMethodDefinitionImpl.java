...
public class TMethodDefinitionImpl extends TMemberImpl implements TMethodDefinition {
		...
		if (signature != null && signature.eIsProxy()) {
			...
			if (signature != oldSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypeGraphBasicPackage.TMETHOD_DEFINITION__SIGNATURE, oldSignature, signature));
			}
		}
		return signature;
	}
	...
	public NotificationChain basicSetSignature(TMethodSignature newSignature, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypeGraphBasicPackage.TMETHOD_DEFINITION__SIGNATURE, oldSignature, newSignature);
	...
	public void setSignature(TMethodSignature newSignature) {
		if (newSignature != signature) {
			...
			if (signature != null)
				msgs = ((InternalEObject)signature).eInverseRemove(this, TypeGraphBasicPackage.TMETHOD_SIGNATURE__DEFINITIONS, TMethodSignature.class, msgs);
			if (newSignature != null)
				msgs = ((InternalEObject)newSignature).eInverseAdd(this, TypeGraphBasicPackage.TMETHOD_SIGNATURE__DEFINITIONS, TMethodSignature.class, msgs);
			msgs = basicSetSignature(newSignature, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypeGraphBasicPackage.TMETHOD_DEFINITION__SIGNATURE, newSignature, newSignature));
	}
	...
	public TMethodDefinition getOverriding() {
		if (overriding != null && overriding.eIsProxy()) {
			...
			if (overriding != oldOverriding) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERRIDING, oldOverriding, overriding));
			}
		}
		return overriding;
	}
	...
	public NotificationChain basicSetOverriding(TMethodDefinition newOverriding, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERRIDING, oldOverriding, newOverriding);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOverriding(TMethodDefinition newOverriding) {
		if (newOverriding != overriding) {
			NotificationChain msgs = null;
			if (overriding != null)
				msgs = ((InternalEObject)overriding).eInverseRemove(this, TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERRIDDEN_BY, TMethodDefinition.class, msgs);
			if (newOverriding != null)
				msgs = ((InternalEObject)newOverriding).eInverseAdd(this, TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERRIDDEN_BY, TMethodDefinition.class, msgs);
			msgs = basicSetOverriding(newOverriding, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERRIDING, newOverriding, newOverriding));
	}
	...
	public EList<TMethodDefinition> getOverriddenBy() {
		if (overriddenBy == null) {
			overriddenBy = new EObjectWithInverseResolvingEList<TMethodDefinition>(TMethodDefinition.class, this, TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERRIDDEN_BY, TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERRIDING);
		}
		return overriddenBy;
	}
	...
	public EList<TMethodDefinition> getOverloading() {
		if (overloading == null) {
			overloading = new EObjectWithInverseResolvingEList.ManyInverse<TMethodDefinition>(TMethodDefinition.class, this, TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERLOADING, TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERLOADED_BY);
		}
		return overloading;
	}
	...
	public EList<TMethodDefinition> getOverloadedBy() {
		if (overloadedBy == null) {
			overloadedBy = new EObjectWithInverseResolvingEList.ManyInverse<TMethodDefinition>(TMethodDefinition.class, this, TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERLOADED_BY, TypeGraphBasicPackage.TMETHOD_DEFINITION__OVERLOADING);
		}
		return overloadedBy;
	}
	...
	public TClass getReturnType() {
		if (returnType != null && returnType.eIsProxy()) {
			...
			if (returnType != oldReturnType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypeGraphBasicPackage.TMETHOD_DEFINITION__RETURN_TYPE, oldReturnType, returnType));
			}
		}
		return returnType;
	}
	...
	public void setReturnType(TClass newReturnType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypeGraphBasicPackage.TMETHOD_DEFINITION__RETURN_TYPE, oldReturnType, returnType));
	}
