...
public class TMethodSignatureImpl extends TSignatureImpl implements TMethodSignature {
	...
	public TMethod getMethod() {
		if (eContainerFeatureID() != TypeGraphBasicPackage.TMETHOD_SIGNATURE__METHOD) return null;
	...
	public void setMethod(TMethod newMethod) {
		if (newMethod != eInternalContainer() || (eContainerFeatureID() != TypeGraphBasicPackage.TMETHOD_SIGNATURE__METHOD && newMethod != null)) {
	...
	public EList<TMethodDefinition> getDefinitions() {
		if (definitions == null) {
			definitions = new EObjectWithInverseResolvingEList<TMethodDefinition>(TMethodDefinition.class, this, TypeGraphBasicPackage.TMETHOD_SIGNATURE__DEFINITIONS, TypeGraphBasicPackage.TMETHOD_DEFINITION__SIGNATURE);
		}
		return definitions;
	}
