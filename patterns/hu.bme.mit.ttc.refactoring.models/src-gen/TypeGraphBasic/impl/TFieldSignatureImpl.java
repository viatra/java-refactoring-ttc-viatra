...
public class TFieldSignatureImpl extends TSignatureImpl implements TFieldSignature {
	...
	public EList<TFieldDefinition> getDefinitions() {
		if (definitions == null) {
			definitions = new EObjectWithInverseResolvingEList<TFieldDefinition>(TFieldDefinition.class, this,
					TypeGraphBasicPackage.TFIELD_SIGNATURE__DEFINITIONS, TypeGraphBasicPackage.TFIELD_DEFINITION__SIGNATURE);
		}
		return definitions;
	}
