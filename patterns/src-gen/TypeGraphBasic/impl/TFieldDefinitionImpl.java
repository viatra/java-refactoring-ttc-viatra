...
public class TFieldDefinitionImpl extends TMemberImpl implements TFieldDefinition {
		...
		if (hiding != null && hiding.eIsProxy()) {
			...
			if (hiding != oldHiding) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypeGraphBasicPackage.TFIELD_DEFINITION__HIDING, oldHiding,
							hiding));
			}
		}
		return hiding;
	...
	public NotificationChain basicSetHiding(TFieldDefinition newHiding, NotificationChain msgs) {
		...
		hiding = newHiding;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TypeGraphBasicPackage.TFIELD_DEFINITION__HIDING,
					oldHiding, newHiding);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setHiding(TFieldDefinition newHiding) {
		if (newHiding != hiding) {
			...
			if (hiding != null)
				msgs = ((InternalEObject) hiding).eInverseRemove(this, TypeGraphBasicPackage.TFIELD_DEFINITION__HIDDEN_BY,
						TFieldDefinition.class, msgs);
			if (newHiding != null)
				msgs = ((InternalEObject) newHiding).eInverseAdd(this, TypeGraphBasicPackage.TFIELD_DEFINITION__HIDDEN_BY,
						TFieldDefinition.class, msgs);
	...
	public EList<TFieldDefinition> getHiddenBy() {
		if (hiddenBy == null) {
			hiddenBy = new EObjectWithInverseResolvingEList<TFieldDefinition>(TFieldDefinition.class, this,
					TypeGraphBasicPackage.TFIELD_DEFINITION__HIDDEN_BY, TypeGraphBasicPackage.TFIELD_DEFINITION__HIDING);
		}
		return hiddenBy;
	}
	...
	public TFieldSignature getSignature() {
		if (signature != null && signature.eIsProxy()) {
			...
			if (signature != oldSignature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypeGraphBasicPackage.TFIELD_DEFINITION__SIGNATURE,
	...
	public NotificationChain basicSetSignature(TFieldSignature newSignature, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					TypeGraphBasicPackage.TFIELD_DEFINITION__SIGNATURE, oldSignature, newSignature);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setSignature(TFieldSignature newSignature) {
		if (newSignature != signature) {
			NotificationChain msgs = null;
			if (signature != null)
				msgs = ((InternalEObject) signature).eInverseRemove(this, TypeGraphBasicPackage.TFIELD_SIGNATURE__DEFINITIONS,
						TFieldSignature.class, msgs);
			if (newSignature != null)
				msgs = ((InternalEObject) newSignature).eInverseAdd(this, TypeGraphBasicPackage.TFIELD_SIGNATURE__DEFINITIONS,
						TFieldSignature.class, msgs);
			msgs = basicSetSignature(newSignature, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypeGraphBasicPackage.TFIELD_DEFINITION__SIGNATURE, newSignature,
					newSignature));
	}
