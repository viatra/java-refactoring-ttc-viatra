...
/**
 * Pattern-specific match representation of the hu.bme.mit.ttc.refactoring.patterns.pumNames pattern,
 * to be used in conjunction with {@link PumNamesMatcher}.
 * 
...
public abstract class PumNamesMatch extends BasePatternMatch {
  ...
  private PumNamesMatch(final String pParentName, final String pChild1Name, final String pChildNName) {
  ...
  public List<String> parameterNames() {
    return PumNamesMatch.parameterNames;
  }
  ...
  @Override
  public PumNamesMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof PumNamesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    PumNamesMatch other = (PumNamesMatch) obj;
  ...
  @Override
  public PumNamesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static PumNamesMatch newEmptyMatch() {
   ...
   * 
   */
  public static PumNamesMatch newMutableMatch(final String pParentName, final String pChild1Name, final String pChildNName) {
   ...
   * 
   */
  public static PumNamesMatch newMatch(final String pParentName, final String pChild1Name, final String pChildNName) {
    return new Immutable(pParentName, pChild1Name, pChildNName);
  }
  
  private static final class Mutable extends PumNamesMatch {
  ...
  private static final class Immutable extends PumNamesMatch {
