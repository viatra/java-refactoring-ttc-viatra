...
/**
 * Pattern-specific match representation of the hu.bme.mit.ttc.refactoring.patterns.commonParent pattern,
 * to be used in conjunction with {@link CommonParentMatcher}.
 * 
...
public abstract class CommonParentMatch extends BasePatternMatch {
  ...
  private CommonParentMatch(final TClass pParent, final TClass pChild1, final TClass pChildN) {
  ...
  public List<String> parameterNames() {
    return CommonParentMatch.parameterNames;
  }
  ...
  @Override
  public CommonParentMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof CommonParentMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    CommonParentMatch other = (CommonParentMatch) obj;
  ...
  @Override
  public CommonParentQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static CommonParentMatch newEmptyMatch() {
   ...
   * 
   */
  public static CommonParentMatch newMutableMatch(final TClass pParent, final TClass pChild1, final TClass pChildN) {
   ...
   * 
   */
  public static CommonParentMatch newMatch(final TClass pParent, final TClass pChild1, final TClass pChildN) {
    return new Immutable(pParent, pChild1, pChildN);
  }
  
  private static final class Mutable extends CommonParentMatch {
  ...
  private static final class Immutable extends CommonParentMatch {
