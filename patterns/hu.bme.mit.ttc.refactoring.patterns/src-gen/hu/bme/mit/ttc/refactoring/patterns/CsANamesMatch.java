...
/**
 * Pattern-specific match representation of the hu.bme.mit.ttc.refactoring.patterns.csANames pattern,
 * to be used in conjunction with {@link CsANamesMatcher}.
 * 
...
public abstract class CsANamesMatch extends BasePatternMatch {
  private String fChild1Name;
  
  private String fChildNName;
  
  private static List<String> parameterNames = makeImmutableList("child1Name", "childNName");
  
  private CsANamesMatch(final String pChild1Name, final String pChildNName) {
  ...
  public List<String> parameterNames() {
    return CsANamesMatch.parameterNames;
  }
  
  @Override
  public Object[] toArray() {
    return new Object[]{fChild1Name, fChildNName};
  }
  
  @Override
  public CsANamesMatch toImmutable() {
    return isMutable() ? newMatch(fChild1Name, fChildNName) : this;
  }
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof CsANamesMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    CsANamesMatch other = (CsANamesMatch) obj;
  ...
  @Override
  public CsANamesQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static CsANamesMatch newEmptyMatch() {
   ...
   * 
   */
  public static CsANamesMatch newMutableMatch(final String pChild1Name, final String pChildNName) {
    return new Mutable(pChild1Name, pChildNName);
  }
   ...
   * 
   */
  public static CsANamesMatch newMatch(final String pChild1Name, final String pChildNName) {
    return new Immutable(pChild1Name, pChildNName);
  }
  
  private static final class Mutable extends CsANamesMatch {
    Mutable(final String pChild1Name, final String pChildNName) {
      super(pChild1Name, pChildNName);
    }
  ...
  private static final class Immutable extends CsANamesMatch {
    Immutable(final String pChild1Name, final String pChildNName) {
      super(pChild1Name, pChildNName);
    }
