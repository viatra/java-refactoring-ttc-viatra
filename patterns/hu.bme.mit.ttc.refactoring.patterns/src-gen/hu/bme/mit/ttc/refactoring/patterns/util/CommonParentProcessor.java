...
/**
 * A match processor tailored for the hu.bme.mit.ttc.refactoring.patterns.commonParent pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class CommonParentProcessor implements IMatchProcessor<CommonParentMatch> {
  /**
  ...
  @Override
  public void process(final CommonParentMatch match) {
