...
/**
 * Pattern-specific match representation of the hu.bme.mit.ttc.refactoring.patterns.classWithName pattern,
 * to be used in conjunction with {@link ClassWithNameMatcher}.
 * 
...
public abstract class ClassWithNameMatch extends BasePatternMatch {
  ...
  private ClassWithNameMatch(final TClass pTClass, final String pClassName) {
  ...
  public List<String> parameterNames() {
    return ClassWithNameMatch.parameterNames;
  }
  ...
  @Override
  public ClassWithNameMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ClassWithNameMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ClassWithNameMatch other = (ClassWithNameMatch) obj;
  ...
  @Override
  public ClassWithNameQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ClassWithNameMatch newEmptyMatch() {
   ...
   * 
   */
  public static ClassWithNameMatch newMutableMatch(final TClass pTClass, final String pClassName) {
   ...
   * 
   */
  public static ClassWithNameMatch newMatch(final TClass pTClass, final String pClassName) {
    return new Immutable(pTClass, pClassName);
  }
  
  private static final class Mutable extends ClassWithNameMatch {
  ...
  private static final class Immutable extends ClassWithNameMatch {
